...
<body style="background-color:whitesmoke;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <br><br>
            <p style="color:gray;">This website is created by</p>
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Hemal Naik</h1>
            <p style="color:gray;"><b>Intern at The Sparks Foundation<br> Rizvi College of Engineering</b></p>
    </center>
